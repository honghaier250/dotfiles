...
# Basic Dependencies
deps_bin="automake autopoint byacc|yacc g++ gcc git libtool pkg-config"
deps_dev="asound blkid BulletSoftBody check dbus-1 fontconfig freetype fribidi gif GL gstreamer-1.0 gstvideo-1.0 jpeg lua|lua5.1|lua5.2 luajit-5.1 mount png pam pulse rsvg-2 sndfile ssl tiff udev xml2 X11 xcb xcb-keysyms xcb-shape Xcursor Xcomposite Xext Xinerama Xp Xrandr Xss Xtst"
